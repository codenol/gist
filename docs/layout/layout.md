...
*   **Adobe Spectrum**: Не выравнивайте каждый атом по сетке.
    ...
    *   ![Spectrum Alignment Don't](Responsive%20grid%20-%20Spectrum_files/responsive-grid_usage-guidelines_alignment_dont@2x_f9BmbOY3J3gl1JvHVhnlf_1611635463289.png)
    *   ![Spectrum Alignment Do](Responsive%20grid%20-%20Spectrum_files/responsive-grid_usage-guidelines_alignment_do@2x_3W1EVSTL3f9SHmQqb5r9aF_1611635462387.png)

*   **Dell Design System**:
    *   ✅ **Do**: Контент должен начинаться и заканчиваться по краям колонок.
    *   ![Dell Best Practices](images/Dell_Design_System_Grid_Best_Practices_212007_V1_2e96ac7bd0.png)
...
*   **Adobe Spectrum**:
    ...
    *   ![Spectrum Gaps Don't](Responsive%20grid%20-%20Spectrum_files/responsive-grid_usage-guidelines_gaps_dont@2x_5fziOL7xOJh7lhWMIXPbrI_1611635464220.png)
...
*   **PENCIL (Brainly)**:
    ...
    *   ![Pencil Form Do](Layout%20·%20PENCIL%20·%20zeroheight_files/4H_hMBskjh6UfQ4Pi5gXIA.svg)
    *   ❌ **Don't**: Не растягивайте текстовый контент на всю ширину (12 колонок). Это делает строки слишком длинными для чтения.
    *   ![Pencil Text Don't](Layout%20·%20PENCIL%20·%20zeroheight_files/op4JwUpixldMBpLnZp0GTg.svg)
...
*   **Adobe Spectrum**:
    ...
    *   ![Spectrum Panels Do](Responsive%20grid%20-%20Spectrum_files/responsive-grid_usage-guidelines_panels_do@2x_6iU5YbJN6dUIU1r9aBMtPy_1611635465042.png)
...
![Ontario Desktop Grid](images/Ontario_Design_System_DS_Grid-ColumnDesktop_Guidance.png)
...
![Dell 12 Column Grid](images/Dell_Design_System_Grid_12_Column_212007_V1_790892c547.png)
...
![UAE Design System Grid](images/and_spacing_guidelineUAE_design_system_2.0_layout_grid-01.png)
...
![Apple 2 Column](images/Apple_Developer_Documentation_visual-design-grid-2-column2x.png)
![Apple 4 Column](images/Apple_Developer_Documentation_visual-design-grid-4-column2x.png)
...
![Dell Margins](images/Dell_Design_System_Grid_Alt_Margin_Width_212007_V1_38b66975db.png)
...
![Dell Gutter Size](images/Dell_Design_System_Grid_Gutter_Size_212007_V1_b0c0689360.png)
...
![Dell Vertical Spacing](images/Dell_Design_System_Grid_Vertical_Spacing_212007_V1_fb977aaab5.png)
...
![Dell Density Modes](images/Dell_Design_System_Grid_Density_212007_V1_ae5f1e2c96.png)
